...
export function FirstSectionForm() {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col sm:flex-row space-x-3 z-10 mt-5 pb-5 ">
        <FormField
          control={form.control}
          name="username"
          render={({ field }) => (
            <FormItem className="flex items-end text-gray-500 w-full">
              <FormLabel className="w-28">City/Town</FormLabel>
              <FormControl>
