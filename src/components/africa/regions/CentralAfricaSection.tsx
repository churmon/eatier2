...
export default function CentralAfricaSection({text1,text2}:{text1:string, text2:string}) {
  return (
    <div className="bg-white w-full pb-5">
        <div className="relative ">
            ...
            <div className="grid grid-cols-1 mt-5 md:grid-cols-4 place-items-center gap-6 mx-5">
                <div>
                    <FirstSectionCountryCard text="Cameroon" />
                </div>
                <div>
                    <FirstSectionCountryCard text="Sao Tome and Principe" />
                </div>
                <div>
                    <FirstSectionCountryCard text="Gabon" />
                </div>
                <div>
                    <FirstSectionCountryCard text="Congo" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 mt-5 md:grid-cols-4 place-items-center gap-6 mx-5">
                <div>
                    <FirstSectionCountryCard text="Kinshasa" />
                </div>
                <div>
                    <FirstSectionCountryCard text="Bangui" />
                </div>
                <div>
                    <FirstSectionCountryCard text="N'Djamena" />
                </div>
                <div>
                    <FirstSectionCountryCard text="Brazzaville" />
                </div>
            </div>
            ...
            <div className="text-xl mt-8 ml-2 text-gray-900">Beyond exceptional places for you</div>
            ...
            <div className="text-xl mt-8 ml-2 text-gray-900">Chefs just make food taste better.</div>
            ...
            <div className="text-xl mt-8 ml-2 text-gray-900">Promoted.</div>
