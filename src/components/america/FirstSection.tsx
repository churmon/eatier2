...
export default function FirstSection() {
    ...
    const navItems:any = [
        { href: 'america/north-america', text:'North America' },
        { href: 'america/south-america', text:'South America' },
        { href: 'america/caribbeans', text:'The Caribbeans' },
        { href: 'america/shop-america', text:'Shop America',icon:true },
        { href: 'america/central-america', text:'Central America' },
    ...
    <div className="bg-white w-full pb-5">
        <div className="relative ">
            ...
            <div className="text-white absolute top-20 sm:top-28 left-3 z-10">
                <div className="flex font-bold text-xl my-3">The Americas // Essentially yours</div>
                <div className="hidden sm:block">Good food, good times.</div>
            </div>
            ...
            <div className="">
                ...
                <div className="md:ml-12 -mt-6 text-gray-500">Truly magnificent.</div>
                <div>
            ...
            <div className="grid grid-cols-1 mt-5 md:grid-cols-4 place-items-center gap-6 mx-5">
                <div className="-skew-x-[20deg]  h-[300px] mx-auto">
                    <FirstSectionCountryCard text="Argentina • South America" />
                </div>
                <div className="-skew-x-[20deg]  h-[300px] mx-auto">
                    <FirstSectionCountryCard text="Panama • Central America" />
                </div>
                <div className="-skew-x-[20deg]  h-[300px] mx-auto">
                    <FirstSectionCountryCard text="Northwest Territories • North America" />
                </div>
                <div className="-skew-x-[20deg]  h-[300px] mx-auto">
                    <FirstSectionCountryCard text="Barbados • Caribbean" />
                </div>
            </div>
